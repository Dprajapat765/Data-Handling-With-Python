...
conn = mysql.connector.connect(user='dineshkumar', password='prajapati', host='db4free.net', database = 'dineshdatabase11')
#, database = 'forsk_test'
...
client = pymongo.MongoClient("mongodb+srv://dinesh_kumar:Prajapati000@cluster0-5adeo.mongodb.net/test")
mydb = client.forsk_db
...
mongodb+srv://dinesh_kumar:Prajapati000@cluster0-5adeo.mongodb.net/test
